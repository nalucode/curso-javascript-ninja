(function() {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/g, 'Luan Vinicius'));
  ...
  */
  ...
  console.log(text.replace(/brasileiro/,'guaçuano'))
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g, function(captura){return captura.toUpperCase()}))
